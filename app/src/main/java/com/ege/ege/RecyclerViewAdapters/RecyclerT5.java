...
public class RecyclerT5 extends RecyclerView.Adapter<RecyclerT5.PostHolderT5> {
    Context mContext;
    ...
    @NonNull
    @Override
    public PostHolderT5 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.item_tekrar, parent, false);

        return new PostHolderT5(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PostHolderT5 holder, int position) {
    ...
    public static class PostHolderT5 extends RecyclerView.ViewHolder {
        ...
        public PostHolderT5(@NonNull View itemView) {
            super(itemView);
