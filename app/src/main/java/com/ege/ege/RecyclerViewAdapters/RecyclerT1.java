...
public class RecyclerT1 extends RecyclerView.Adapter<RecyclerT1.PostHolderT1> {
    Context mContext;
    ...
    @NonNull
    @Override
    public PostHolderT1 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.item_tekrar, parent, false);

        return new PostHolderT1(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PostHolderT1 holder, int position) {
    ...
    public static class PostHolderT1 extends RecyclerView.ViewHolder {
        ...
        public PostHolderT1(@NonNull View itemView) {
            super(itemView);
