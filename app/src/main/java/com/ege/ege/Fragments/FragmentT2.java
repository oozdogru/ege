...
import com.ege.ege.RecyclerViewAdapters.RecyclerT2;
...
public class FragmentT2 extends Fragment {
    ...
    RecyclerT2 feedRecyclerAdapter;
    ArrayList<Tekrarlar_item> list_tekrar;
    View v;
    private FirebaseAuth firebaseAuth;
    private FirebaseFirestore firebaseFirestore;
    private RecyclerView recyclerTekrar3;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.t2, container, false);
        ...
        timerThread1.start();
        RecyclerView recyclerView = v.findViewById(R.id.recyclerTekrar3);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        feedRecyclerAdapter = new RecyclerT2(getContext(), list_tekrar, userEmailFromFB, userKonuAdıFromFB, userTeoriFromFB, userPratikFromFB, userYüzdeFromFB, userKaçıncıTekrarFromFB, userAralıkFromFB);
