...
import com.ege.ege.RecyclerViewAdapters.RecyclerT1;
...
public class FragmentT1 extends Fragment {
    ...
    RecyclerT1 feedRecyclerAdapter;
    ArrayList<Tekrarlar_item> list_tekrar;
    View v;
    private FirebaseAuth firebaseAuth;
    private FirebaseFirestore firebaseFirestore;
    private RecyclerView recyclerTekrar2;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.t1, container, false);
        ...
        RecyclerView recyclerView = v.findViewById(R.id.recyclerTekrar2);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        feedRecyclerAdapter = new RecyclerT1(getContext(), list_tekrar, userEmailFromFB, userKonuAdıFromFB, userTeoriFromFB, userPratikFromFB, userYüzdeFromFB, userKaçıncıTekrarFromFB, userAralıkFromFB);
